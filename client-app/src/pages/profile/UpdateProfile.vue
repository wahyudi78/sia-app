...
import { Guru, updateGuru } from "../../http/guru";
...
onMounted(async () => {
  await Guru(id).then((result) => {
    ...
    console.log(result.data.data.tanggal_lahir);
  });
});
</script>
  ...
  <div class="card p-3 m-5 w-50">
    <form @submit.prevent="update">
      ...
      <div class="form-group">
        ...
        <input asp-format="{0:yyyy-MM-dd}" v-model="data.tanggal_lahir" type="date" class="form-control" id="tanggal_lahir" />
